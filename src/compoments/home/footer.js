...
function Footer() {
    return (
        <footer className="container-fluid bg-dark mt-5  text-light z-1"  id="con" >

            <div className="container d-flex align-items-center justify-content-evenly">
                <div className="row ">
                    <div className="col mt-5">
                        <h2 className="text-center footertitles">Information</h2>
                        <p className="container">Welcome to the AI & Dev Club a community where you learn,build,and grow with AI and development.Join us for hands-on projects,expert sessions,and a chance to create real-world impact through technology.</p>
                    </div>
                    <div className="col mt-5">
                        <h2 className="text-center footertitles">contact</h2>
                        <p className="ms-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                            </svg>
                            <a href="https://www.google.com/maps/place/%D9%83%D9%84%D9%8A%D8%A9+%D8%A7%D9%84%D8%B9%D9%84%D9%88%D9%85+%D8%A7%D8%A8%D9%86+%D9%85%D8%B3%D9%8A%D9%83%E2%80%AD/@33.566615,-7.5389047,17z/data=!4m14!1m7!3m6!1s0xda633261bbe100f:0xe48b03dd8c6794a0!2z2YPZhNmK2Kkg2KfZhNi52YTZiNmFINin2KjZhiDZhdiz2YrZgw!8m2!3d33.5666106!4d-7.5414796!16s%2Fg%2F11fzpkjwyn!3m5!1s0xda633261bbe100f:0xe48b03dd8c6794a0!8m2!3d33.5666106!4d-7.5414796!16s%2Fg%2F11fzpkjwyn?entry=ttu&g_ep=EgoyMDI1MDQzMC4xIKXMDSoASAFQAw%3D%3D" class="link-light ms-2 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" target="_blank">Faculty Of Science BenMSICK, FSBM</a>
                        </p>
                        <p className="ms-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-fill" viewBox="0 0 16 16">
                                <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z" />
                            </svg>
                            <a href="#" className="link-light ms-2 link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">aidevcommunity735@gmail.com</a>
                        </p>
                    </div>
                    <div className="col mt-5 ">
                        <h2 className="text-center footertitles">Follow Us</h2>
                        <div class="cardfooter  ms-2">
                            ...
                            <a href="#" className="socialContainer containerTwo">
                                <svg className="socialSvg tiktokSvg largeIcon" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                            ...
                            <a href="#" className="socialContainer containerThree">
                                <div>
                                    <svg className="socialSvg tiktokSvg largeIcon" width="44px" height="44px" viewBox="0 0 45 35" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="row">
                    <div className="col text-center">
                        ...
                        <p>&copy;2025 All Rights Reserved,AI&DEV Community</p>
                    </div>
             </div>
        </footer>
    )
